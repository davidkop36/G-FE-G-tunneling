function graphene_plot_band_structure_qc_twisted_debug(V,Vg,Vi,Q_top,Q_bottom,theta,flag)
...
% y2 = -hbar*Vf*x/e_el+Vi;
 ...
 offset = 8*pi/(3*1.42e-10)*sin(theta/2);
...
y3 = hbar*Vf*(x1-offset)/e_el-Vi; %like adding V_kp
y4 = -hbar*Vf*(x1-offset)/e_el-Vi;
if flag ==0
figure;
end
